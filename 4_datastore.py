...
writetomeplease = open("retail_space.csv", 'w')

writetomeplease.write("room-number,use,sq-ft,price\n")
for element in datastore["medical"]:
    lineitem=''
    for ugh in element:
        lineitem = lineitem + element[ugh].__str__() + ","
    writetomeplease.write(lineitem[:-1]+"\n")
